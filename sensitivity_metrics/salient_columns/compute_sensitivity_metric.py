...
class DataArguments:
    ...
    dataset_path: Optional[str] = field(
        ...
        metadata={
            "help": (
                "Location of the Pile dataset. " 
                "You can download the validation dataset of the Pile at "
                "https://huggingface.co/datasets/mit-han-lab/pile-val-backup/resolve/main/val.jsonl.zst"
            )
        }
    )
    output_path: Optional[str] = field(
        default=None, metadata={"help": "The path to file where computed metric will be saved."}
    )
    trust_remote_code: bool = field(
        default=False,
        metadata={
    ...
    num_samples: Optional[int] = field(
        ...
        metadata={
            "help": (
                "Number of samples which will be used to compute metrics. "
            )
        },
    )
