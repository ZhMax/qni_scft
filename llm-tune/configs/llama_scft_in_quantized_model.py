...
def model_configs():
    ...
    config.loading_quik_quant_weight = {
        'load_weight': True, #load quantized weights with scales from state_dict to replace full-precision weights of the model 
    ...
    config.BitNoiseQuant = {
        ...
        'compute_scale': False, #compute quantization scales for noise 
    ...
    ### NORM TWEEKING ###
    config.norm_tweek = False #train parameters of LlamaRMSNorm
